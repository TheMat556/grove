...
import { saisonCreateSchema } from "@/lib/schemas/saison";
...
export async function createSaisonAction(
	...
	const parsed = saisonCreateSchema.safeParse({
	...
	try {
		...
		return {
			message:
				e instanceof Error ? e.message : "Saison konnte nicht angelegt werden.",
		};
	}
