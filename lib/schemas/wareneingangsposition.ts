...
export const wareneingangspositionInsertSchema = wareneingangpositionSchema.omit({
	id: true,
});
export type Wareneingangsposition = z.infer<typeof wareneingangpositionSchema>;
export type WareneingangspositionInsert = z.infer<typeof wareneingangspositionInsertSchema>;
